...
import { ScheduleCalendarService, CalendarViewType, Department } from '../../../features/schedule/services/schedule-calendar.service';
...
export class ScheduleComponent implements OnInit {
  ...
  getShiftClass(shiftTypeId: number): string {
    switch (shiftTypeId) {
